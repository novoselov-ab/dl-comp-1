...
def run_experiment(tag, optimizer, regularizer = None, dropout = 0.5):
        ...
        model.load_weights('saved_bbox_models/attempt_resnet_1py20170121-223100[ResNet50]RMSprop_lr0.002_d1e-05_l20.00500_d0.5163-0.77.hdf5')
        ...
        mc = ModelCheckpoint(filepath='saved_bbox_models/' + model_name + '{epoch:02d}-{val_acc:.2f}' + '.hdf5', monitor='val_acc', save_best_only=True, period=1)
        reduce_lr = ReduceLROnPlateau(monitor='val_acc', factor=0.2, patience=14)
...
run_experiment('[ResNet50]', RMSprop(lr=0.0005, decay=0), l2(0.005), 0.5)

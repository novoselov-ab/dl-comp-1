...
IMAGE_SIZE = 224
BATCH_SIZE = 24
EPOCH_FILES_FRACTION = 0.2
DATA_FOLDER = 'generated_train_cropped_multiple_05_224x224_bbox_blit_5000'
RGB = True
...
run_experiment('[ResNet50]', RMSprop(lr=0.0002, decay=0), l2(0.005), 0.5)

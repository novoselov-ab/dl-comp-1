...
def BuildModel(nb_classes, regularizer = None, dropout = 0.5):
    ...
    fire4_expand1 = Convolution2D(
        96, 1, 1, init=init, W_regularizer=regularizer,
    ...
    fire4_expand2 = Convolution2D(
        96, 3, 3, init=init, W_regularizer=regularizer,
...
def run_experiment(tag, optimizer, regularizer = None, dropout = 0.5):
        ...
        es = EarlyStopping(patience=50, monitor='val_acc')
...
run_experiment('[no_tag]', Adam(lr=0.002, decay=1e-5), l2(0.005), 0.5)
run_experiment('[no_tag]', RMSprop(lr=0.002, decay=1e-5), l2(0.005), 0.5)

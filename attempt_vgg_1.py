...
import os
import pickle
from convnetskeras.convnets import VGG_16
...
run_experiment('[VGG16]', RMSprop(lr=0.001, decay=1e-5), l2(0.0002), 0.5)
#run_experiment('[ResNet50]', RMSprop(lr=0.001, decay=0), l2(0.005), 0.5)
run_experiment('[VGG16]', Adam(lr=0.001, decay=0), l2(0.005), 0.5)
